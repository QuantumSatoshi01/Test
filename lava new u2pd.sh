...
function remove_node() {
    printDelimiter
    printGreen "Видаляємо застарілу версію Lava"
    printDelimiter
    ...
    printDelimiter
    printGreen "Через декілька секунд, розпочнеться звичайний процес встановлення ноди"
    printDelimiter
}
...
function restore_files() {
    printDelimiter
    printGreen "Переносимо бекап файли в нову версію ноди Lava"
