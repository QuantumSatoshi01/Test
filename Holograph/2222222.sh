...
echo ""
read -p "$(printGreen 'Якщо ви виконали всі умови,та вперше встановлюєте ноду,введіть 1.Якщо ви запросили вдруге 100 $HLG та маєте на балансі 200 $HLG у 3 мережах,введіть 2[1/2]: ')" answer
